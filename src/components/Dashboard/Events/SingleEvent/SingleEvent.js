...
const SingleEvent = ({ isPreview, isLoaded, event }) => {
  ...
  const isExpired = () => {
    ...
    const startDate =
      basicInfo.dateOccurrence === 'single'
        ? basicInfo.dateTime.start
        : sortedSchedule[0];
    const endDate =
      basicInfo.dateOccurrence === 'single'
        ? basicInfo.dateTime.end
  ...
  const handleIncreaseCount = (id) => {
    const existingTicketIndex = ticketNumber.findIndex(
      (ticket) => ticket.id === id
    );
              ...
              <div className='col-md-8'>
                <div className='card-body'>
                  <h6 className='card-title'>
                    {getLocalDateString(filterSortSchedule(schedule)[0].start)}
                  </h6>
                  <h2 className='card-title'>
                    <strong>{basicInfo.eventTitle}</strong>
                  </h2>
                  <p className='card-text py-4'>{details.summary}</p>
                  <div
                    className={`p-4 d-flex justify-content-between align-items-center ${styles.followContainer}`}
                  >
                    <div className='d-flex align-items-center justify-content-center'>
                      ...
                      <div className='px-3'>
                        <p className='card-text mb-0'>
                          By <strong>{basicInfo.organizer}</strong>{' '}
                        </p>
                        <p className='card-text mt-2'>
                          {formatNumber(111493)} followers
                        </p>
                      </div>
                    </div>
                    <div className=''>
                              ...
                              <Grid container item spacing={1}>
                                <Grid container item spacing={2}>
                                  <React.Fragment>
                                      ...
                                      .map((el) => (
                                        ...
                                        >
                                          <Item
                                            className={`  ${
                                              dateClicked === el.id
                                                ? styles.activeCalendarCard
                                                : ''
                                            }`}
                                          >
                                            <div
                                              onClick={() =>
                                                setDateClicked(el.id)
                                              }
                                            >
                                              <div
                                    ...
                                    {filterSortSchedule(schedule).length >
                                      3 && (
                        ...
                        {basicInfo.locationState === 'venue' && (
                          <>
                            ...
                            <Box display={showMap ? 'block' : 'none'}>
                              <Map
                                isLoaded={isLoaded}
                                location={basicInfo.location.location}
                              />
                            </Box>
                          </>
                        )}
                  ...
                  <div className='mb-5'>
                    ...
                    <div className='d-flex'>
                      ...
                      >
                        <div className={`${styles.aboutEventHeadIcon}`}>
                          <BsClockHistory />
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <CardContent>
                          ...
                          <Box
                            className={`${styles.cardGlobalIcon}`}
                            color='#3559E3'
                          >
                            <AiOutlineGlobal />
                          </Box>
                  ...
                  <Box sx={{ textAlign: 'center' }}>
                    <Typography size='small' sx={{ mt: 2, color: '#3559E3' }}>
                      {' '}
                      <ImFlag sx={{ mr: 2 }} /> <span>Report this event</span>
                    </Typography>
                  </Box>
                </div>
              </div>
