...
const FullCalendarComponent = ({ setData, defaultDates }) => {
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
        ...
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogContent>
            ...
            >
              <Grid item xs={12} md={6} sx={{ mb: { xs: 3 } }}>
                <label htmlFor='inputStart_6754' className='form-label'>
                  Starts
                </label>
                <DateTimePicker
                  fullWidth
                  value={
                    selectedEvent ? new Date(selectedEvent.startStr) : null
                  }
                  onChange={(date) =>
                    setSelectedEvent({
                      ...selectedEvent,
                  ...
                  minDateTime={
                    selectedEvent
                      ? new Date(selectedEvent.startStr)
                      : new Date()
                  }
                  viewRenderers={{
              ...
              <Grid item xs={12} md={6} sx={{ mb: { xs: 3 } }}>
                <label htmlFor='inputEnd_6754' className='form-label'>
                  Ends
                </label>
                <DateTimePicker
                  fullWidth
          ...
          <DialogActions>
            ...
            <Button variant='contained' onClick={handleEventUpdate}>
              Update
            </Button>
          </DialogActions>
        </Dialog>
