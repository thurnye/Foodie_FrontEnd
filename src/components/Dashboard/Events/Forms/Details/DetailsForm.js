    ...
    <div>
                ...
                {about?.length === 0 ? (
                  <>
                    <Typography variant='body2' gutterBottom>
                      ...
                      You can include things to know, venue information,
                      parking, accessibility options-anything that will help
          ...
          <Box sx={{}}>
            <Card>
              <CardContent>
                ...
                <Box sx={{ mb: 3 }}>
                  <Typography variant='caption' color='text.secondary'>
                    Add more details about your event and include what people
      ...
      <Box sx={{ mb: 2 }}>
        {activeSection !== 'faqForm' && (
          <Box
            sx={{}}
            onClick={() => faqs?.length === 0 && setActiveSection('faqForm')}
          >
            <Card
              ...
              <CardContent>
                {faqs?.length === 0 ? (
                  <>
                    ...
                    <Typography variant='body2' gutterBottom>
                      Make your event stand out even more. These sectons help
                      attendees find information and answers their questions -
                      which means more ticket sales and less time answering
                      messages.
                    </Typography>
                  </>
                ) : (
          ...
          <Box sx={{}}>
            <Card>
              <CardContent>
                ...
                <Box sx={{ mb: 3 }}>
                  <Typography variant='caption' color='text.secondary'>
                    Answer questions your attendees may have about the event,
                    like parking, accessibility, refunds, and other
                    informations.
                  </Typography>
                </Box>
