...
const About = ({setAbout, about, setActiveSection}) => {
    ...
    const Controls = () => <>
        <Avatar sx={{ bgcolor: 'red[500]', cursor: 'pointer', mt: {xs: 2, md: 4}, mr: {xs: 2, md: 'initial'}  }} aria-label="add" onClick={() => setChecked(!checked)}> + </Avatar>
        {/* Text */}
        <Grow in={checked} sx={{mt: 2, cursor: 'pointer', mr: {xs: 2, md: 'initial'} }}>
        ...
        >
            ...
            aria-label="recipe"
            onClick={() => {
                append({ type: "image", value: "", isUnsplash:false, isMultiple: true})
                setChecked(!checked) 
                }}
            >
                <FaRegImage />
        ...
        >
            ...
            aria-label="recipe"
            onClick={() => {
                append({ type: "image", value: "", isUnsplash:true, isMultiple: true })
