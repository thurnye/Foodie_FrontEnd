...
export const Editor = ({ type, control, errors, isRequired, name, label, placeholder, children, errorMessage, defaultValue, ...rest }) => (
  <Box sx={{ mb: 3 }}>
    <Controller
      name={name}
      control={control}
...
export const ReactSelectInput = ({ defaultValue, label, isRequired, errorMessage, control, errors, placeholder, options, name, ...rest }) => <Box sx={{mb: 3}}>
  {/* <ReactSelect name={name} placeholder={placeholder} control={control} options={options} {...rest}/> */}
