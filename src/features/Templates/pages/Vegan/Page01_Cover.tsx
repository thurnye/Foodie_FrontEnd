// Vegan Template - Page 1: Cover
import React from "react";
import { Box, Typography } from "@mui/material";
import { Spa } from "@mui/icons-material";

export const VeganPage01_Cover: React.FC = () => {
  return (
    <Box sx={{ width: "100%", minHeight: "100vh", bgcolor: "#f5f5f5", display: "flex", justifyContent: "center", alignItems: "center", py: 6 }}>
