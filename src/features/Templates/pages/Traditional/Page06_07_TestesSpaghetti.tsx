// Traditional Template - Pages 6-7: Testes Spaghetti Spread
...
export const TraditionalPage06_07_TestesSpaghetti: React.FC<Props> = ({
  title = "TESTES SPAGHETTI",
  subtitle = "A classic Italian pasta dish",
  mainImg = "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=800&h=600&fit=crop",
  smallImgs = [
    ...
    "https://images.unsplash.com/photo-1608219992759-8d74ed8d76eb?w=300&h=200&fit=crop",
  ],
  ingredients = [
