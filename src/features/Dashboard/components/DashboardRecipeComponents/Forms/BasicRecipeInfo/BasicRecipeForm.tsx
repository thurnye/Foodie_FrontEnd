...
import { useMetaDataHook } from '../../../../hooks/dashboard.recipe.hook';
import { FormContainer, Input, ReactSelectInput } from '../../../../../../app/components/FormContainer';
import { IRecipeBasicInfo } from '../../../../../Recipe/types/recipe.types';

interface BasicRecipeFormProps {
  setData: React.Dispatch<React.SetStateAction<IRecipeBasicInfo | undefined>>;
  defaultValues: IRecipeBasicInfo;
}

const BasicRecipeForm: React.FC<BasicRecipeFormProps> = ({
  setData,
  defaultValues,
}) => {
  ...
  const onSubmit = (data: IRecipeBasicInfo) => {
    if (data) {
      console.log({ data });
      setData({ ...data });
    }
...
export default BasicRecipeForm;
